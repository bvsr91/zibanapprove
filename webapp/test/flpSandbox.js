		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IBAN Approve",
									"targetURL": "#comferrerozibanapprove-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comferrerozibanapprove-display": {
								"semanticObject": "comferrerozibanapprove",
								"action": "display",
								"description": "App",
								"title": "IBAN Approve",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ferrero.zibanapprove",
									"url": sap.ui.require.toUrl("com/ferrero/zibanapprove")
								}
							}
						}
					}
